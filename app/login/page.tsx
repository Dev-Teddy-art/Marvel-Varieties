...
import { Lock, Mail, Phone, User, ArrowLeft, Eye, EyeOff, KeyRound, Loader2 } from 'lucide-react';
      ...
      <div className="flex bg-slate-100 p-1 rounded-2xl text-xs font-bold">
        <button
          ...
          className={`flex-1 py-2.5 rounded-xl transition cursor-pointer ${
            !isRegistering ? 'bg-[#0B1B3D] text-[#D4AF37] shadow-xs' : 'text-slate-500 hover:text-slate-900'
          }`}
        >
          Sign In
        </button>
